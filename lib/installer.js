...
function getDownloadInfo(version) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (version) {
            ...
            return { url: `https://github.com/github/hub/releases/download/v${version}/hub-${platform}-amd64-${version}${fileExtension}`, version: version };
        }
        else {
            //get latest release
            ...
            return { url: `https://github.com/github/hub/releases/latest/download/hub-${platform}-amd64-${latestVersion}${fileExtension}`, version: latestVersion };
        }
    });
}
